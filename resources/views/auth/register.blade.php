            ...
            <div class="col-lg-5 col-md-5 ml-auto">
                <div class="info-area info-horizontal mt-5">
                    ...
                    <div class="description">
                        <h5 class="info-title">{{ __('Attention') }}</h5>
                        <p class="description">
                            Registeration is only for testing purposes, use OATH to login with student details </p>
                    </div>
                </div>
                    ...
                    <div class="card-body ">
                        <form class="form" method="POST" action="{{ route('register') }}">
                            ...
                            <div class="input-group{{ $errors->has('student_id') ? ' has-danger' : '' }}">
                                ...
                                <input name="student_id" type="text" class="form-control" placeholder="Student ID" required value="{{ old('student_id') }}">
